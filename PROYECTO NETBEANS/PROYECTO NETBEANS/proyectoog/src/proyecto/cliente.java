...
public class cliente extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        pizzerialogin cuenta = new pizzerialogin();
    ...
    try {
        ...
        try {
            ...
            PreparedStatement pstmtCliente = conn.prepareStatement(sqlCliente, Statement.RETURN_GENERATED_KEYS);
            pstmtCliente.setString(1, nombre);
            pstmtCliente.executeUpdate();
            
            // 3. Insertar usuario relacionado
            String sqlUsuario = "INSERT INTO usuarios (username, password, role) VALUES (?, ?, 'vendedor')";
            PreparedStatement pstmtUsuario = conn.prepareStatement(sqlUsuario);
            pstmtUsuario.setString(1, username);
            pstmtUsuario.setString(2, password); // En producción: usar BCrypt
            ...
            this.dispose();
            new pizzerialogin().setVisible(true);
